...
$subject = "Konfirmasi Pendaftaran - Spelling Bee Lombok Regional Competition 2026";

// Template HTML Email Konfirmasi Pendaftaran (Sesuai Wording & KV MarCom)
$htmlMessage = '
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Konfirmasi Pendaftaran Spelling Bee Lombok 2026</title>
</head>
          ...
          <tr>
            <td style="padding:32px; font-size:15px; line-height:1.6; color:#334155;">
              ...
              <p style="margin-top:0; font-size:15px; color:#0f172a; line-height:1.6;">
                Saat ini, tim English 1 sedang melakukan proses verifikasi kelengkapan data diri atas nama <strong>' . $participantName . '</strong> dan pembayaran yang sudah terproses. Tim kami akan menghubungi Anda melalui <strong>WhatsApp</strong> dan mengirimkan <strong>bukti pembayaran</strong> jika proses verifikasi telah selesai.
              </p>

              <p style="font-size:15px; color:#0f172a; margin:16px 0; line-height:1.6;">
                Jika ada pertanyaan atau kendala, silahkan menghubungi official hotline number English 1 Lombok.
              </p>

              <p style="font-size:16px; font-weight:600; color:#e00078; margin:24px 0 0 0;">
                Sampai jumpa di Spelling Bee Lombok Regional Competition 2026!
              </p>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td style="font-size:14px; color:#475569; line-height:1.5;">
                    ...
                    <p style="margin:0 0 2px 0; font-weight:700; color:#0f172a; font-size:15px;">English 1 Lombok</p>
