          ...
          <tr>
            <td style="padding:32px; font-size:15px; line-height:1.6; color:#334155;">
              ...
              <p style="margin-top:0; font-size:15px; color:#0f172a; line-height:1.6;">
                Saat ini, tim English 1 Bali sedang melakukan proses verifikasi kelengkapan data diri atas nama <strong>' . $participantName . '</strong> dan pembayaran yang sudah terproses. Tim kami akan menghubungi Anda melalui <strong>WhatsApp</strong> dan mengirimkan <strong>bukti pembayaran</strong> jika proses verifikasi telah selesai.
              </p>
